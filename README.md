...
STCS is a tweeter bot platform for analysis on Twitter. Find research work using this platform [here](http://dl.acm.org/citation.cfm?id=2889360). Find main author [here](http://www.cl.cam.ac.uk/~szuhg2/).
