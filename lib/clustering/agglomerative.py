...
# -*- coding: utf-8 -*-
"""
Agglomerative Clustering for clustering Twitter accts by using
python scikit-learn (sklearn) AgglomerativeClustering class.

(agglomerative/hierarchical clustering)
refr: https://en.wikipedia.org/wiki/Hierarchical_clustering
refr: http://scikit-learn.org/stable/modules/clustering.html
libr: http://scikit-learn.org/stable/modules/generated/sklearn.cluster.AgglomerativeClustering.html
...
(execute)
python agglomerative.py /input/to/userengagements.csv /output/to/
"""
...
'''
Apply Agglomerative Clustering to the tweet feature-set
...
def process_agglomerative(): 
	...
	labels = AgglomerativeClustering(n_clusters=7).fit_predict(X)
	...
	for cluster in clusters:
		f = open(sys.argv[2]+"/agglomerative."+sys.argv[1].split("/")[-1:].pop()+".cluster"+str(cluster)+".out", "w+")
