# usage: ruby textEN.rb /fully/qualified/path/to/directory[accts] /fully/qualified/path/to/filelist[accts] /fully/qualified/path/to/output/directory
require 'zlib'
require 'json'
