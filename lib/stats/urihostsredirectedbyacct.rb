# usage: ruby urihostsredirectedbyacct.rb /fully/qualified/path/to/directory[accts] /fully/qualified/path/to/directory
require 'zlib'
require 'json'
require 'uri'
require 'csv'
...
acct_list.each do |acct|
  begin
    ...
    CSV.open("#{ARGV[1]}/#{acct}.txt", 'a') { |csv| urihosts.to_a.each {|elem| csv << elem} }
    # reset vars
    text = ""
    textp1 = ""
    textp2 = ""
