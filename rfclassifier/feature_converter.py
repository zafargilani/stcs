...
def writing_out(a_dict, a_file, out_folder):
    ...
    header = "screen_name,user_tweets,user_retweets,user_favourites,user_replies_and_mentions,likes_per_tweet,retweets_per_tweet,lists_account_age_ratio,follower_friend_ratio,tweet_frequency,favourite_tweet_ratio,age_of_account_in_days,sources_count,urls_count,cdn_content_in_kb,label\n"
    f.write(header)
